    ...
    */
    ...
    public function setUrlStrategy($url_strategy)
    {
        ...
        if ((mb_strlen($url_strategy) > 50)) {
            throw new \InvalidArgumentException('invalid length for $url_strategy when calling Merchant., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($url_strategy) < 0)) {
            throw new \InvalidArgumentException('invalid length for $url_strategy when calling Merchant., must be bigger than or equal to 0.');
        }
