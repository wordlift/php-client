...
/**
 * PageMerchantSync Class Doc Comment
 *
 * @category Class
 ...
 */
class PageMerchantSync implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PageMerchantSync';
    ...
    protected static $openAPITypes = [
        'first' => 'string',
        'items' => '\Wordlift\Client\Model\MerchantSync[]',
        'last' => 'string',
        'next' => 'string',
        'prev' => 'string',
        'self' => 'string'
    ...
    */
     ...
     * Sets items
     *
     * @param \Wordlift\Client\Model\MerchantSync[] $items An array of objects.
     *
     * @return self
     */
