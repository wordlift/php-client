 ...
 */
class VectorSearchQueryResponseItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VectorSearchQueryResponseItem';
    ...
    */
     ...
     * Sets iri
     *
     * @param string $iri The IRI of the entity that this node belongs to.
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets node_id
     *
     * @param string|null $node_id A nodes id.
     *
     * @return self
     */
     ...
     * Sets score
     *
     * @param float $score The similarity score between the node and the query embeddings.
     *
     * @return self
     */
     ...
     * Sets text
     *
     * @param string|null $text The text of a node from which the embeddings were generated.
     *
     * @return self
     */
