 ...
 */
class InternalLinkRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InternalLinkRequest';
    ...
    */
     ...
     * Sets template
     *
     * @param string|null $template The output template, not required, we provide a default JSON-LD template
     *
     * @return self
     */
