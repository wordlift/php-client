...
class RedeemCodesApi
{
    ...
    {
        list($response) = $this->redeemCodeWithHttpInfo($request, $contentType);
        return $response;
    }

    /**
     * Operation redeemCodeWithHttpInfo
     *
     * Redeem the provided code and get a key
     *
     ...
     */
    public function redeemCodeAsync($request, string $contentType = self::contentTypes['redeemCode'][0])
    {
        return $this->redeemCodeAsyncWithHttpInfo($request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation redeemCodeAsyncWithHttpInfo
     *
     * Redeem the provided code and get a key
     *
     * @param  \Wordlift\Client\Model\Request $request (required)
     ...
     */
    public function redeemCodeRequest($request, string $contentType = self::contentTypes['redeemCode'][0])
    {

        // verify the required parameter 'request' is set
        if ($request === null || (is_array($request) && count($request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $request when calling redeemCode'
            );
        }


        $resourcePath = '/redeem-codes';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
